...
links: [[10 - Anatomia de um Pitch]] | [[12 - Apresentação Visual]] | [[Estudos/Projetos/00-Maps/🗺️ Mapa Principal]]
...
flowchart TD
    subgraph GC["Golden Circle"]
        PQ["🟡 POR QUÊ\n(o propósito, a crença)"]
        CO["⬜ COMO\n(o processo, o diferencial)"]
        OQ["⬜ O QUÊ\n(o produto, a entrega)"]
    end

    PQ --> CO --> OQ

    style PQ fill:#FAEEDA,stroke:#854F0B,color:#633806
```
