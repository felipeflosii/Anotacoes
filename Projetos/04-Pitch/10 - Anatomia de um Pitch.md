...
links: [[09 - Estrutura Financeira]] | [[11 - Storytelling do Projeto]] | [[12 - Apresentação Visual]] | [[🗺️ Mapa Principal]]
...
```mermaid
flowchart TD
    B1["1️⃣ GANCHO\nCaptura atenção em 15 segundos"]
    B2["2️⃣ PROBLEMA\nEstabelece a dor que você resolve"]
    B3["3️⃣ SOLUÇÃO\nApresenta o seu projeto"]
    B4["4️⃣ DEMONSTRAÇÃO\nMostra funcionando (protótipo, MVP)"]
    B5["5️⃣ MERCADO / IMPACTO\nQuem se beneficia e qual a escala"]
    B6["6️⃣ TIME\nPor que vocês são as pessoas certas"]
    B7["7️⃣ CHAMADA PARA AÇÃO\nO que você quer que façam agora"]

    B1 --> B2 --> B3 --> B4 --> B5 --> B6 --> B7

    style B1 fill:#FAECE7,stroke:#993C1D,color:#712B13
    style B3 fill:#E1F5EE,stroke:#0F6E56,color:#085041
    style B7 fill:#EEEDFE,stroke:#534AB7,color:#3C3489
```
